...
<template>
  <div class="fixed w-full h-screen bg-black">
    <div
      v-if="!showFullVideo"
      id="SideNav"
      class="flex z-40 w-[120px] h-screen bg-black items-center relative"
    >
      <img
    ...
    <div v-if="!showFullVideo">
      ...
      >
        <div
          class="absolute z-30 h-[600px] left-[120px] w-[77%] top-0 right-0 bg-gradient-to-r from-black via-black"
        />
    ...
    <div
      v-if="!showFullVideo"
      class="absolute z-20 h-[70%] left-[120px] w-[100%] bottom-0 right-0 bg-gradient-to-t from-black via-black"
    />
    <div v-if="showFullVideo">
      <div
